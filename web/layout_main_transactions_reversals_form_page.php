...
<div class="content-wrapper  hidden" id="main_transactions_reversals_form">
    <!-- Content Header (Page header) -->
    <?php 
        echo _ace_page_header("Reversal Form",array(
            utils_bread_crump_item("Home","main/dashboard"),
            utils_bread_crump_item("Reversal Form","","active")
        )); 
    ?>
